                ...
                {[
                  {
                    icon: GraduationCap,
                    title: "Education",
                    desc: "English language programs for local school students.",
                  },
                  {
                    icon: Book,
                    title: "Facilities",
                    desc: "Built and stocked a library for the village school.",
                  },
                  {
                    icon: HeartPulse,
                    title: "Health",
                    desc: "Clean water filters to prevent chronic kidney disease.",
                  },
                  {
                    icon: Lightbulb,
                    title: "Empowerment",
                    desc: "Entrepreneurship programs for local youth.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                ...
                <div className="relative rounded-[40px] overflow-hidden shadow-2xl border-8 border-white transform hover:rotate-1 transition-transform duration-500">
                  <img
                    src={
                      images?.impact_community ||
                      defaultImagess?.split ||
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-muted text-lg mb-8 leading-relaxed text-center">
                ...
                diseases. Consequently, all our initiatives aim to reduce our
                environmental footprint while restoring natural ecosystems.
              </p>
