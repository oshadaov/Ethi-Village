...
export default function WhyEtiliSection() {
  ...
  const remoteImage = images?.why_etili;
  const whyImage =
    !loading && remoteImage
      ? remoteImage
    ...
    <section className="section section-soft">
      <Container className="split-layout">
        <div>
          ...
          <div className="feature-list">
            <div className="feature-card">
              ...
              <p>
                Meet local hosts and experience village traditions in a genuine,
                welcoming setting.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                Enjoy dishes prepared with fresh local ingredients and
                traditional methods.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                Step away from crowded tourist paths and enjoy a slower rhythm
                of travel.
              </p>
            </div>
          </div>
        ...
        <div className="split-image">
          <img src={whyImage} alt="Nature and village atmosphere" />
        </div>
      </Container>
    </section>
  );
